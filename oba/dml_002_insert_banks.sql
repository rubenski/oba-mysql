...
INSERT INTO bank_api_2_main_service(bank_api_id, api_service_system_name) VALUES (UUID_TO_BIN('ca80d196-a8cb-11ea-bb37-0242ac130002'), 'pis');
INSERT INTO bank_api_2_main_service(bank_api_id, api_service_system_name) VALUES (UUID_TO_BIN('ca80d196-a8cb-11ea-bb37-0242ac130002'), 'ais');

INSERT INTO bank_api(id, type, bank_system_name, base_url, request_signing_used, request_signing_algorithm, mutual_tls_used, is_sandbox) VALUES
(UUID_TO_BIN('ca80d362-a8cb-11ea-bb37-0242ac130002'), 'PSD2', 'asn-bank-nl', 'https://api.regiobank.nl', true,  'RSA_2048', true, true);
INSERT INTO bank_api_2_main_service(bank_api_id, api_service_system_name) VALUES (UUID_TO_BIN('ca80d362-a8cb-11ea-bb37-0242ac130002'), 'pis');
INSERT INTO bank_api_2_main_service(bank_api_id, api_service_system_name) VALUES (UUID_TO_BIN('ca80d362-a8cb-11ea-bb37-0242ac130002'), 'ais');

INSERT INTO bank_api(id, type, bank_system_name, base_url, request_signing_used, request_signing_algorithm, mutual_tls_used, is_sandbox) VALUES
(UUID_TO_BIN('ca80d434-a8cb-11ea-bb37-0242ac130002'), 'PSD2', 'sns-bank-nl', 'https://api.regiobank.nl', true,  'RSA_2048', true, true);
INSERT INTO bank_api_2_main_service(bank_api_id, api_service_system_name) VALUES (UUID_TO_BIN('ca80d434-a8cb-11ea-bb37-0242ac130002'), 'pis');
INSERT INTO bank_api_2_main_service(bank_api_id, api_service_system_name) VALUES (UUID_TO_BIN('ca80d434-a8cb-11ea-bb37-0242ac130002'), 'ais');

INSERT INTO bank_api(id, type, bank_system_name, base_url, request_signing_used, request_signing_algorithm, mutual_tls_used, is_sandbox) VALUES
(UUID_TO_BIN('ca80d4fc-a8cb-11ea-bb37-0242ac130002'), 'PSD2', 'regiobank-nl', 'https://api.regiobank.nl', true, 'RSA_2048', true, true);
INSERT INTO bank_api_2_main_service(bank_api_id, api_service_system_name) VALUES (UUID_TO_BIN('ca80d4fc-a8cb-11ea-bb37-0242ac130002'), 'pis');
INSERT INTO bank_api_2_main_service(bank_api_id, api_service_system_name) VALUES (UUID_TO_BIN('ca80d4fc-a8cb-11ea-bb37-0242ac130002'), 'ais');

INSERT INTO bank_api(id, type, bank_system_name, base_url, request_signing_used, request_signing_algorithm, mutual_tls_used, is_sandbox) VALUES
(UUID_TO_BIN('ca80d5ba-a8cb-11ea-bb37-0242ac130002'), 'PSD2', 'ing-bank-nl', 'https://api.ing.nl', true, 'RSA_2048', true, true);
INSERT INTO bank_api_2_main_service(bank_api_id, api_service_system_name) VALUES (UUID_TO_BIN('ca80d5ba-a8cb-11ea-bb37-0242ac130002'), 'pis');
INSERT INTO bank_api_2_main_service(bank_api_id, api_service_system_name) VALUES (UUID_TO_BIN('ca80d5ba-a8cb-11ea-bb37-0242ac130002'), 'ais');
