use oba;
# Banks
INSERT INTO financial_organization (system_name, display_name, implementation_key)
...
# Group types
INSERT INTO financial_organization_group_type(id, group_type_name) VALUES (UUID_TO_BIN('ca80cfca-a8cb-11ea-bb37-0242ac130002'), 'REGIONAL_BANKS');
INSERT INTO financial_organization_group_type(id, group_type_name) VALUES (UUID_TO_BIN('ca80d0c4-a8cb-11ea-bb37-0242ac130002'), 'BANKING_GROUP');
...
# Bank APIs
INSERT INTO api(id, type, financial_organization_system_name, base_url, request_signing_used, request_signing_algorithm, mutual_tls_used, is_sandbox) VALUES
